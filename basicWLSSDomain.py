...
addTemplate("/u01/app/oracle/product/j2ee/wlserver_10.3/common/templates/domains/sipserverdomain.jar")
...
writeDomain('/u01/app/oracle/product/j2ee/user_projects/domains/basicWLSSDomain')
closeTemplate()
